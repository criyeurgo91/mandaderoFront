...
function MandersList() {
  ...
  return (
    <div className="bg-whithe text-white min-h-screen">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-5 py-3 text-black">Mandaderos</h2>
        {alertMessage && <div className="text-red-500">{alertMessage}</div>}
        <div className="flex mb-4">
          <input
            type="text"
            className="w-1/2 border-2 border-gray-500 bg-blue-700 h-10 px-6 rounded-lg text-sm focus:outline-none"
            placeholder="Buscar..."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredManders.map((mander, index) => (
            <div key={index} className="bg-blue-700 rounded-lg shadow-md p-2 border border-black">
