...
function UpdateServiceForm({ serviceId, onUpdate, onClose }) {
  ...
  const fetchServiceData = async () => {
    try {
      const response = await axios.get(`http://manders.azurewebsites.net/api/service/${serviceId}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(`http://manders.azurewebsites.net/api/service/${serviceId}/`, formData);
